...
const experiences = [
  ...
  },
  {
    ...
    period: '2022 – 2023',
    location: 'Oakland, CA',
    descKo: '비영리 교육 기관에서 학생 데이터를 분석하여 프로그램 개선에 활용했습니다. Python과 SQL(BigQuery)을 이용해 학생 성과 대시보드를 구축하고, 데이터 기반 인사이트로 의사결정을 지원했습니다.',
    descEn: 'Analyzed student data at a nonprofit to improve educational programs. Built student performance dashboards with Python and SQL (BigQuery), providing data-driven insights to support organizational decision-making.',
    tech: ['Python', 'SQL', 'BigQuery', 'Tableau', 'Excel', 'Data Analysis'],
