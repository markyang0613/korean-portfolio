...
const projects: Project[] = [
  ...
  {
    id: 11,
    title: 'Olist Marketplace: 5-Layer Health Monitoring System',
    titleKo: '마켓플레이스 지표 분석 대시보드',
    category: 'data',
    categoryLabel: '데이터분석',
    size: 'large',
    descKo: 'Olist 이커머스 데이터(10만+ 주문)로 당근마켓형 양면 시장의 건전성을 모니터링하는 5계층 분석 프레임워크를 구축했습니다. 롤링 Z-스코어 GMV 이상 감지, Prophet 6개월 예측, 판매자 이탈 위험 스코어링(전체 33.9% 위험군), 구매자 코호트 리텐션(1개월 7.1%), 양면 시장 네트워크 효과 정량화까지 포함한 운영 대시보드입니다.',
    descEn: 'Built a 5-layer marketplace health monitoring framework on Olist e-commerce data (100k+ orders). Includes rolling z-score GMV anomaly detection, Prophet 6-month forecast, seller churn risk scoring (33.9% at-risk), buyer cohort retention (7.1% M1), and two-sided network effect quantification.',
    tech: ['Python', 'Prophet', 'Pandas', 'DuckDB', 'Scipy', 'Matplotlib'],
    aiUsage: 72,
    github: 'https://github.com/markyang0613/olist-marketplace-funnel-analytics',
    color: '#39ff14',
    icon: '📈',
    highlights: ['Prophet GMV 예측 (6개월 선행)', '판매자 이탈 위험 스코어링 (33.9%)', '구매자 코호트 리텐션 분석 (M1: 7.1%)'],
  },
  {
    id: 12,
